...
?>
  ...
  <div class="alert alert-success alert-dismissable">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
             Anda berada di Halaman Detail Hasil Pencarian Tugas Akhir
          </div>
  ...
  <div class="panel panel-primary">
    <div class="panel-heading">Data Tugas Akhir </i></div>
      <div class="panel-body" >
        ...
        <div class="col-md-9 col-md-offset-2" >
          <div>
            <label class="col-md-2">File</label><span class="col-md-10"><a href="../admin/download.php?nim=<?php echo $data['nim'] ?>"><?php echo $data['file'];?></a></span>
          </div>
        </div>
        <div class="col-md-9 col-md-offset-2" >
          <div>
            </br>
            <a href="../admin/pencarian.php" class="btn btn-primary">Kembali</a>
          </div>
        </div>
       </div>
      </div>
