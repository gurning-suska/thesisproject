  ...
  <body>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
          <li class="active"><a href="../admin/profil.php" class="active"><span class="glyphicon glyphicon-user"></span> 
        ...
        <div class="container">
            ...
            <div class="row" align="center">
              <div class="col-md-6 col-md-offset-3"> 
                <a href="../admin/ganti_password.php" class="btn btn-warning">Ganti Password</a>
              </div>
            </div>
        </div>
      </div>
