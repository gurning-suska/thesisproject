        ...
        <div class="container">
          <h4>Pencarian Data Tugas Akhir</h4><hr width="40%" align="left">
            <form action="pencarian.php" method="post" role="search">
              <div class="row">
                <div class="col-md-5 col-md-offset-3"><input type="text" name="cari" class="form-control" placeholder="Masukkan judul                            Max.255 Characters"></div>&nbsp;
                  ...
                  if(isset($_POST['cari']))
                    { 
                      ...
                      /*else
                      {
                        ...
                        {
                          echo "Maaf judul yang anda cari tidak sesuai. Coba masukkan judul dengan lebih lengkap.";
                        }
                    ?>
              </table>  
