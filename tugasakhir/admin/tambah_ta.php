...
?>
  ...
  <div class="alert alert-success alert-dismissable">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
             Anda sekarang berada di Halaman Tambah Data Tugas Akhir
          </div>
  <!-- Main component for a primary marketing message or call to action -->
   <?php
      $query = mysql_query("SELECT nama_dosen FROM dosen");
      $data  = mysql_fetch_array($query);
    ?>
  <div class="panel panel-danger">
    <div class="panel-heading"> Tambah Data Tugas Akhir</div>
        ...
        <div class="container"></div>
            ...
            <form action="insert_ta.php" method="post" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="col-md-6"><input type="text" name="nim" class="form-control" placeholder="NIM" required></div>
              </div>
              </br>
              <div class="row">
                <div class="col-md-2 col-md-offset-2" align="left"><label for="penulis">Penulis</label></div>
                <div class="col-md-6"><input type="text" name="penulis" id="penulis" class="form-control" placeholder="Penulis" required></div>
              </div>
            </br>
              <div class="row">
                <div class="col-md-2 col-md-offset-2" align="left"><label for="judul">Judul</label></div>
                <div class="col-md-6"><textarea type="text" name="judul" class="form-control" placeholder="Judul" required></textarea></div>
              </div>
            </br>
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-6"><input type="text" name="sidang" id="datepicker" class="form-control" placeholder="Tanggal Sidang" required></div>
              </div>
              </br>
              <div class="row">
                <div class="col-md-2 col-md-offset-2" align="left">
                  <label for="wisuda">Periode Wisuda</label>
                </div>
                              <div class="col-md-4" >
                                <select type="text" name="bulan" class="form-control" required>
                                  <option selected="selected">Bulan</option>
                                    <?php
                                    $bulan=array("Februari","Maret","Juni","Agustus","November");
                                    $jlh_bln=count($bulan);
              ...
              <div class="row">
                ...
                <div class="col-md-6"><input name="file_upload"  type="file"  id="file" placeholder="File" required/></div>
              </div>
              </br>
