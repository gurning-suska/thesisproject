...
?>
  ...
  <div class="alert alert-success alert-dismissable">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
             Anda sekarang berada di Halaman Tambah Data User
          </div>
        ...
        <div class="container">
            ...
            <form action="insert_user.php" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-6"><input type="text" name="id_user" id="id_user" class="form-control" placeholder="ID User" required></div>
              </div>
            </br>
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-6"><input type="text" name="password" id="password" class="form-control" placeholder="Password" required></div>
              </div>
              </br>
              <div class="row">
                <div class="col-md-2 col-md-offset-2" align="left"><label for="level">Level</label></div>
                <div class="col-md-6"> 
                  <select  type="text" name="level" id="level" class="form-control" value="Pilih" required>
