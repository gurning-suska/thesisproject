  ...
  <div class="panel panel-primary">
    <div class="panel-heading">Data Tugas Akhir </i></div>
      <div class="panel-body" >
        ...
        <div class="col-md-9 col-md-offset-2" >
          <div>
            <label class="col-md-2">File</label><a href="../admin/download.php?nim=<?php echo $data['nim'] ?>"><?php echo $data['file'];?></a></span>
          </div>
        </div>
        <div class="col-md-9 col-md-offset-2" >
          <div>
            </br>
            <a href="../user/pencarian.php" class="btn btn-primary">Kembali</a>
          </div>
        </div>
       </div>
      </div>
